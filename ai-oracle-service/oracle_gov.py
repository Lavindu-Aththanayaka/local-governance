...
from config import ABI_PATH, ORACLE_CONTRACT_ADDRESS, GOV_PRIVATE_KEY, RPC_URL
...
if not PRIVATE_KEY:
    raise RuntimeError("Missing ORACLE_GOV_PRIVATE_KEY for ai-oracle-service/oracle_gov.py")
