...
ABI_PATH = Path(
    get_env(
        "ORACLE_ABI_PATH",
        default=str(
            (BASE_DIR / "../smart-contracts/artifacts/contracts/Reporting.sol/Reporting.json").resolve()
        ),
    )
)
...
# Backwards-compatible alias for any code still importing the shorter name.
